...
const reply = (teks) => {
            XeonBotInc.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botname}`,"body": ` Join Bot's Official GC`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./XeonMedia/cheemspic.jpg`),"sourceUrl": "https://chat.whatsapp.com/JKQhbkXTEW0GCN4RNeJSE8"}}}, { quoted: m})
        }
...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     await XeonBotInc.send5ButImg(from, `` + '' + teksehmazeh, `© ${footer}`, xeonbotinc, [{"urlButton": {"displayText": "Instagram📍","url": 'https://www.instagram.com/shafi_258011'}}])
  }
  break
        case 'userlimit': 
{      
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Script🔖',
                                    url: 'https://pranx.com/matrix-code-rain/'
                                }
                            }, {
                                urlButton: {
                                    displayText: 'Instagram📍',
                                    url: 'https://www.instagram.com/shafi_258011'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: '🎀Menu🎀',
...
┃╠ ${prefix}report [bug]
┃╚═════════════✪
┗━━「 ${pushname} 」━⭓`,unicorn, [{"urlButton": {"displayText": "Instagram 📍","url": 'https://www.instagram.com/shafi_258011'}},{"urlButton": {"displayText": "Script🔖","url": 'https://pranx.com/matrix-code-rain/'}}, {"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
...
Xeon (Me)
My family
And All Friends Who Helped Assemble This Sexy Script !!!`,unicorn, [{"urlButton": {"displayText": "Instagram📍","url": 'https://www.instagram.com/shafi_258011'}},{"urlButton": {"displayText": "Script🔖","url": 'https://pranx.com/matrix-code-rain/'}}, {"quickReplyButton": {"displayText": "👤Owner👤","id": 'owner'}}] )
break
            default:
                if (budy.startsWith('=>')) {
